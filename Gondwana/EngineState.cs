...
public sealed class EngineState
{
    ...
    /// embedded inline in the engine-state JSON.
    /// </param>
    /// <param name="separateGsndFile">
    /// If <c>true</c>, audio resources are written to a separate .gsnd file and
        ...
        bool separateGsndFile)
    {
        if (separateGsndFile)
        {
            ...
            var gsndFullPath = Path.Combine(gsndDirectory, "audio.gsnd");
            ...
            {
                GsndPath = MakeRelativePath(gsndFullPath, baseDirectory)
            };
        }
