...
internal sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        Text = "Gondwana Audio — GAUD editor";
        ...
        Add(file, "&Open GAUD…", Keys.Control | Keys.O, OpenFiles);
        ...
        _tree.NodeMouseDoubleClick += (_, e) =>
        {
            ...
            if (Path.GetExtension(path).Equals(".gaud", StringComparison.OrdinalIgnoreCase))
                OpenDocument(path);
    ...
    private static void FillDirectory(TreeNode parent, string path)
    {
        ...
        try
        {
            ...
            foreach (var file in Directory.EnumerateFiles(path)
                         .Where(file =>
                             Path.GetExtension(file).Equals(".gaud", StringComparison.OrdinalIgnoreCase) ||
                             IsAudioFile(file))
    ...
    private void OpenFiles()
    {
        ...
        {
            Filter = "Gondwana audio definitions|*.gaud",
            Multiselect = true,
        ...
        try
        {
            ...
            if (saveAs || path is null)
            {
                using var dialog = new SaveFileDialog
                {
                    ...
                    FileName = path is null ? "audio.gaud" : Path.GetFileName(path)
                };
