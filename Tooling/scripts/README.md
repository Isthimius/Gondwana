...
6. Runs `Generate-Project-Changelogs.ps1` with the resolved version tag to replace each project's running `[Unreleased]` section with the versioned release section.
