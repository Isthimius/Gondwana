...
public sealed class AudioEditorTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "GondwanaGaudEditor-" + Guid.NewGuid());
        ...
        try
        {
            ...
            var firstPath = Path.Combine(first, "audio.gaud");
            ...
            var secondPath = Path.Combine(second, "copy.gaud");
