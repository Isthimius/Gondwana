...
internal sealed class SpotGLGameHost : WinFormsGpuGameHost
{
    ...
    internal SpotGLGameHost(WinFormGpuRenderSurfaceControl renderSurface)
        : base(renderSurface)
    {
    }

    #region WinFormsGpuGameHost overrides
    ...
    #endregion WinFormsGpuGameHost overrides
